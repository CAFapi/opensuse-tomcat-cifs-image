...
This project builds on the openSUSE Tomcat with JRE11 image [here](https://github.com/CAFapi/opensuse-tomcat-jre11-image) to build a pre-configured Tomcat Docker image that has the CIFS utilities pre-installed.
...
Here is an example Dockerfile which uses this image as a base:
    ...
    FROM cafapi/opensuse-tomcat-cifs:latest
